                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <li><a href="<?php echo base_url('anggota/dt_anggota'); ?>" aria-expanded="true"><i class="fa fa-weixin"></i><span>Jawab Pertanyaan</span></a>        
                                
                            </li>
                            <li>
                                <li>
                                    <!-- <a href="<?php echo base_url('anggota/dt_table'); ?>" aria-expanded="true"><i class="fa fa-envelope-o"></i><span>Lihat Jawaban</span></a>         -->
                                
                            </li>
                            <li><a href="<?php echo base_url('anggota/c_anggota/logout'); ?>"><i class="fa fa-location-arrow"></i> <span>Keluar</span></a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Hallo....<?php echo $username; ?></h4>
